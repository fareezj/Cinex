...
class MovieCastList extends StatefulWidget {
  ...
  MovieCastList({this.castId, this.castImage, this.castName, this.castPopularity});
...
class _MovieCastListState extends State<MovieCastList> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, '/actorDetails', arguments: <String, int> {
          'actorId': widget.castId,
        });
      },
      child: Container(
        child: Column(
